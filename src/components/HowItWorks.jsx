...
const steps = [
  {
    ...
    description:
      "Tell us about your interests, passions, and what kind of connections you're looking for. No pressure, no perfection needed.",
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    description:
      'We surface people and events nearby that match your vibe — coffee lovers, hikers, artists, gamers, you name it.',
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    title: 'Meet & Connect',
    description:
      'Show up, say hi, and let real conversations happen. We handle the logistics so you can focus on the moment.',
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    description:
      'Keep building meaningful relationships. Your orbit grows organically through shared experiences and moments.',
    icon: (
      <svg
        width="28"
        height="28"
