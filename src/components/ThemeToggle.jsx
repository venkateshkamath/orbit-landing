...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      {/* Sun icon */}
      <svg
        className={`theme-toggle__icon theme-toggle__sun ${dark ? '' : 'theme-toggle__icon--active'}`}
        width="18"
        height="18"
        viewBox="0 0 24 24"
        fill="none"
      ...
      {/* Moon icon */}
      <svg
        className={`theme-toggle__icon theme-toggle__moon ${dark ? 'theme-toggle__icon--active' : ''}`}
        width="18"
        height="18"
        viewBox="0 0 24 24"
        fill="none"
