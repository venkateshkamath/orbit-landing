    ...
    const fetchCount = async () => {
      try {
        ...
        if (data.count > 0) {
          ...
          setWaitlistCount(328 + data.count);
        }
      } catch (err) {
    ...
    <section ref={heroRef} className="hero" id="hero">
      ...
      <div className="hero__content container">
        ...
        <p ref={subtitleRef} className="hero__subtitle" style={{ opacity: 0 }}>
          ORBIT helps you discover local events, meet like-minded people, and
          build friendships that exist beyond the screen.
        </p>
          ...
          <div className="orbit-system">
            ...
            <div className="orbit-ring orbit-ring--3">
              ...
              >
                <span
                  style={{
                    background: "linear-gradient(135deg, #FF6B6B, #C4B5FD)",
                  }}
                >
                  S
                </span>
          ...
          <div className="hero__social-proof">
            <div className="hero__avatars">
              ...
              <div className="hero__avatar hero__avatar--count">
                {formatAvatarCount(waitlistCount)}
              </div>
            </div>
