...
const testimonials = [
  {
    name: "Anish Shetty",
    handle: "@anishshetty",
    text: "I picked up photography recently but don't know anyone else who enjoys it. Orbit could help me find people who want to explore the city with a camera too.",
    avatar: "A",
  ...
  },
  {
    name: `Sneha D'Souza`,
    handle: "@sneha_dsouza",
    text: "Just moved to Hyderabad for work. New city, new routine, but no real connections yet. Hoping Orbit makes it easier to meet people nearby.",
    avatar: "S",
  ...
  },
  {
    name: "Rohit Pai",
    handle: "@rohitpai",
    text: "I already have a great circle of friends, but I love meeting new people and learning different perspectives. Orbit seems like a great way to expand my network.",
    avatar: "R",
