...
const testimonials = [
  {
    name: "Anish Shetty",
    handle: "@anishshetty",
    text: "I've lived in Mangalore for 3 years. I have 2,000 followers. I go home alone every weekend. Orbit — please launch already.",
    avatar: "A",
  ...
  },
  {
    name: `Sneha D'Souza`,
    handle: "@sneha_dsouza",
    text: "Moved to Bangalore 8 months ago. My contacts list is full. My weekends are empty. Waiting for this.",
    avatar: "S",
  ...
  },
  {
    name: "Rohit Pai",
    handle: "@rohitpai",
    text: "I hike every month alone. Would love to find even two people who want to do the same. Orbit, hurry up.",
    avatar: "R",
